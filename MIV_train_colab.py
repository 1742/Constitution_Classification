...
pretrained_path = r'/content/Constitution_Classification/model/vgg16.pth'
save_path = r'/content/drive/MyDrive/Colab Notebooks/Constitution_Classification'
effect_path = r'/content/runs'
save_figure_path = r'/content/drive/MyDrive/Colab Notebooks/Constitution_Classification/runs/result_1.png'
...
if __name__ == '__main__':
    ...
    optimizer = 'Adam'
    criterion = 'CELoss'
    lr_schedule = {'name': 'ExponentialLR', 'gamma': 0.9}
    ...
    Visualization(effect, True, save_figure_path)
